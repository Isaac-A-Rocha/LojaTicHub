        ...
        <div class="card-grid">
          <div>
            <div class="form-header">
              <h2>Login</h2>
              <p>Entre na sua conta para finalizar a compra e acessar o carrinho.</p>
            </div>
            <form @submit.prevent="handleSubmit" class="form-block">
              ...
              <div class="form-actions">
                <Button
                  ...
                  :loading="loading"
                  :disabled="v$.$invalid"
                  class="p-button-rounded p-button-lg p-button-info"
                  label="Entrar"
                />
          ...
          <div class="card-aside">
            <h3 class="text-xl font-semibold mb-4">Vantagens do login</h3>
            <ul class="space-y-3 text-slate-200">
              <li>• Acesso rápido ao checkout</li>
              <li>• Histórico de pedidos</li>
              <li>• Proteção com autenticação centralizada</li>
              <li>• Redirecionamento automático para a página certa</li>
            </ul>
          </div>
        </div>
      </template>
